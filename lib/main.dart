...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void setStatus(MqttConnectionState status) {
    setState(() {
      state = status;
    });
  }

  void initMQTT5(MqttBrowserClient client) async {
    client.onConnected = () => setStatus(MqttConnectionState.connected);
    client.onDisconnected = () => setStatus(MqttConnectionState.disconnected);
